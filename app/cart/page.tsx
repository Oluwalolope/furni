        ...
        <>
            ...
            <div className="bg-background-main">
                <main className="w-full max-w-[1512px] mx-auto pt-[156px] px-4 md:px-6 lg:px-[138px]">
                    ...
                    <MobileCartView />
                    <div className="mt-16">
                        <Link href='/shop' type="submit" className="py-1.5 px-4 lg:py-3 lg:px-8 bg-[#2F2F2F] hover:bg-[#6D6D6D] transition-all duration-300 cursor-pointer rounded-[100px] capitalize text-[#ffff] font-inter font-semibold  text-lg" >Continue shopping</Link >
                    </div>
                    <div className="flex flex-col gap-y-20 md:flex-row md:justify-between pt-12 pb-[345px]">
                        <div>
                            ...
                            <div className="flex flex-row gap-8 items-center">
                                ...
                                <button className="py-1.5 px-4 lg:py-3 lg:px-8 bg-[#2F2F2F] hover:bg-[#6D6D6D] transition-all duration-300 cursor-pointer rounded-[24px] capitalize text-[#ffff] font-inter font-semibold text-lg">Apply Coupon</button>
                            </div>
                        </div>
                        <CartTotals />
                    </div>
