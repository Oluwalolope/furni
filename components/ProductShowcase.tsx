    ...
    return (
        <section className="flex flex-col justify-center lg:flex-row lg:justify-between py-[185px] items-start gap-x-6 gap-y-38 w-full max-w-[1512px] mx-auto flex-wrap">
            <div className="min-w-[209px] mx-auto">
                ...
                <Link href='/shop' className="py-1.5 px-4 lg:py-3 lg:px-8 bg-[#2F2F2F] hover:bg-[#6D6D6D] transition-all duration-300 cursor-pointer rounded-[100px] capitalize text-white font-inter font-semibold text-lg" >explore</Link>
            </div>
